...
public:
    ...
    void setZVersControlLabels(int64_t nAmount, int nQuantity);
...
// MINT disabled    void on_pushButtonMintzVERS_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzVERS_clicked();
    void on_pushButtonZVersControl_clicked();
