...
#include "key.h"
#include "zvers/accumulatorcheckpoints.h"
...
BOOST_AUTO_TEST_CASE(deterministic_tests)
{
    ...
    CzVERSWallet zWallet(wallet.strWalletFile);
    ...
    for (int i = 0; i < nTests; i++) {
        ...
        zWallet.GenerateDeterministicZVERS(denom, coin, dMint);
