...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nDisplayUnit"))
        settings.setValue("nDisplayUnit", BitcoinUnits::VERS);
...
// Wallet
    ...
    if (settings.contains("nAnonymizeVersessAmount"))
        SoftSetArg("-anonymizeversessamount", settings.value("nAnonymizeVersessAmount").toString().toStdString());
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in versess.cpp during shotdown to also remove the window positions
