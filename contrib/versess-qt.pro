...
RESOURCES += src/qt/versess.qrc src/qt/versess_locale.qrc

TRANSLATIONS += src/qt/locale/versess_bg.ts \
                src/qt/locale/versess_de.ts \
                src/qt/locale/versess_en.ts \
                src/qt/locale/versess_es.ts \
                src/qt/locale/versess_fi.ts \
                src/qt/locale/versess_fr.ts \
                src/qt/locale/versess_it.ts \
                src/qt/locale/versess_ja.ts \
                src/qt/locale/versess_pl.ts \
                src/qt/locale/versess_pt.ts \
                src/qt/locale/versess_ru.ts \
                src/qt/locale/versess_sk.ts \
                src/qt/locale/versess_sv.ts \
                src/qt/locale/versess_vi.ts \
                src/qt/locale/versess_zh_CN.ts \
                src/qt/locale/versess_zh_TW.ts
