...
#ifndef Versess_ZVERSWALLET_H
#define Versess_ZVERSWALLET_H
...
public:
    CzVERSWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZVERS(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZVERS(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
