                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzVERSPathCustom = GetArg("-zversbackuppath", "");
    ...
    if(!strzVERSPathCustom.empty()) {
        ui->wallet_customzversbackuppath->setText(QString::fromStdString(strzVERSPathCustom));
        ui->wallet_customzversbackuppath_label->setVisible(true);
        ui->wallet_customzversbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzVERSPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the Versess RPC console.") + "<br>" +
