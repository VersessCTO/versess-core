...
from fake_stake.base_test import Versess_FakeStakeTest

class zVERSwrappedSerialsTest(Versess_FakeStakeTest):
    ...
    def run_test(self):
        ...
        # 2) Mint zerocoins
        self.log.info("Minting %d-denom zVERSs..." % DENOM_TO_USE)
