...
/** Utility functions used by the Versess Qt UI.
 */
namespace GUIUtil
{
...
// Render Versess addresses in monospace font
...
// Parse "versess:" URI into recipient object, return true on successful parsing
