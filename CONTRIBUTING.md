Contributing to Versess Coin
============================

The Versess Coin project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/versess-project/versess/blob/master/doc/translation_process.md)
...
The following applies to code changes to the Versess Coin project, and is not to be
confused with overall Versess Network Protocol consensus changes.

Whether a pull request is merged into Versess Coin rests with the project merge
...
Patches that change Versess consensus rules are considerably more involved than
...
Where a patchset proposes to change the Versess consensus, it must have been
...
The project leader is the release manager for each Versess Coin release.
