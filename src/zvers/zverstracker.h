...
#ifndef Versess_ZVERSTRACKER_H
#define Versess_ZVERSTRACKER_H
...
public:
    CzVERSTracker(std::string strWalletFile);
    ~CzVERSTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzVERSWallet* zVERSWallet = NULL);
