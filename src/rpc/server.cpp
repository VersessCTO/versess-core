...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    StartShutdown();
    return "Versess server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Versess features */
        {"versess", "listmasternodes", &listmasternodes, true, true, false},
        {"versess", "getmasternodecount", &getmasternodecount, true, true, false},
        {"versess", "masternodeconnect", &masternodeconnect, true, true, false},
        {"versess", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"versess", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"versess", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"versess", "masternodecurrent", &masternodecurrent, true, true, false},
        {"versess", "masternodedebug", &masternodedebug, true, true, false},
        {"versess", "startmasternode", &startmasternode, true, true, false},
        {"versess", "createmasternodekey", &createmasternodekey, true, true, false},
        {"versess", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"versess", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"versess", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"versess", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"versess", "getmasternodescores", &getmasternodescores, true, true, false},
        {"versess", "preparebudget", &preparebudget, true, true, false},
        {"versess", "submitbudget", &submitbudget, true, true, false},
        {"versess", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"versess", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"versess", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"versess", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"versess", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"versess", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"versess", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"versess", "checkbudgets", &checkbudgets, true, true, false},
        {"versess", "mnsync", &mnsync, true, true, false},
        {"versess", "spork", &spork, true, true, false},
        {"versess", "getpoolinfo", &getpoolinfo, true, true, false},
...
{
    return "> versess-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:13810/\n";
}
